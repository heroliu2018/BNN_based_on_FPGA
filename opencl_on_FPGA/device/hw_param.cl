 ...
 *       Author :Yingh Liu
 *       Data 2019.4.4
 *    contents: the parameters for BNN
 *
 * ------------------------------------------------------
...
#define LANE_NUM            2             // larger than 1, for alexnet: 2, 3, 4, 8, 12, 15, 16, 22, 28, 32, 34, 48, 50, 51, 52, 64, ...
#define CHN_DEPTH           0
#define SAMPLE_NUM          2        //sampling number
#define SAMPLE_NUM_DEBUG    50
//MemRD Kernel
#define CONV_GP_SIZE_X      7
#define CONV_GP_SIZE_Y      1              // In this version, CONV_GP_SIZE_Y must be 1
#define WIN_BUF_SIZE        2800/VEC_SIZE  // for 2 layers  batch=1.data size(max in all layers) =(weight_W+GP_size_x-1)*weight_h*weight_n
#define WEIGHT_BUF_SIZE     2800*SAMPLE_NUM/VEC_SIZE  // for 2 layers  batch=1 size= weight_w *h *n/VEC_SIZE  784,,weights need to multiple
